...
#
# KIS-1310: Die Prüfung liegt in services/profil_pruefung.py — ohne FastAPI,
# damit scripts/testlauf_profil.py auf einem Rechner ohne Backend-Abhängigkeiten
# läuft. Hier nur der Re-Export (Tests und ältere Aufrufer).
from services.profil_pruefung import FB2_FELDER as _FB2_FELDER, profil_pruefen  # noqa: F401
