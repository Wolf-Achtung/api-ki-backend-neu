    ...
    try:
        ...
        if _foerder_capped > 0 and _gesamt > _foerder_capped and _monat_spar > 0:
            ...
            _foerder_note = (
                ...
                f'Landesf\u00f6rderung (etwa BAFA-Beratungsf\u00f6rderung plus ein '
                f'Landesprogramm). Welche Programme f\u00fcr Sie infrage kommen, '
                f'zeigt die Tabelle in Kapitel\u00a07. Ein einzelnes F\u00f6rderprogramm '
                f'erreicht meist 50\u201360\u00a0%.'
                f'</span>'
                f'</div>'
            )
            if _ctx_en:
                ...
                _foerder_note = (
                    ...
                    f'with a state-level programme (e.g. the BAFA consulting grant plus a state programme). '
                    f'The table in chapter 7 shows which programmes apply to you. '
