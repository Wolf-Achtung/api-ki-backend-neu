...
FUNDING_PROGRAMMES_2025_2027: List[Dict[str, Any]] = [
    ...
    # Federal-Level Programmes (Germany)
    {
        ...
        "risks": ["Auslaufen möglich 2025"],
        "notes": "Achtung: Programm läuft evtl. 2025 aus - schnell beantragen!",
    },
    {
        "name": "Digital Jetzt",
        "year": 2025,
        ...
        "deadline": "2025",
        "years_available": [2025],
        "requirements": ["3-499 Mitarbeiter", "Investition in digitale Technologien"],
        "risks": ["Budgetausschöpfung"],
    },
    {
        ...
        "risks": ["Komplexe Antragsstellung"],
    },
    {
