...
<!-- Zahlen nur aus gelieferten Variablen (z. B. Stunden-/Budgetwerte), sonst qualitative Einschätzung. -->
    <div>
      ...
      <ul>
        <li>Ad‑Kampagnen‑Varianten & Headlines</li>
        <li>Landingpage‑A/B‑Ideen & Tests</li>
        <li>Social‑Post‑Serien/Redaktionsplan</li>
        <li>Keyword-/Themenclustering für Content</li>
      </ul>
