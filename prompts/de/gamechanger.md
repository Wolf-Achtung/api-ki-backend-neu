...
Case. Erlaubt ist nur der qualitative Verweis „Details zum ROI → siehe
Business Case". (P3b: ersetzt die frühere 200%-Deckel-Regel, die dem
ZERO-TOLERANCE-Block weiter unten widersprach.)
<!--
...
-->
<!-- KIS-PROMPT P3b: Der hier früher folgende ZWEITE komplette Prompt (v7.0,
eigene Rolle/Struktur/Wortlimits, anderes Variablen-Schema company_size/
industry/core_service) wurde ENTFERNT. Er lag seit einem früheren Sprint
zusätzlich unter dem aktiven v7.1/v7.3-Prompt — das Modell erhielt zwei
widersprüchliche Aufträge übereinander (u.a. 400/450/550 vs. 450/500/600
Wörter Limit). -->
