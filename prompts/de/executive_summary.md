<section class="executive-summary" data-branche="{{BRANCHE_LABEL}}" data-groesse="{{UNTERNEHMENSGROESSE_LABEL}}" data-bundesland="{{BUNDESLAND_LABEL}}" data-hauptleistung="{{HAUPTLEISTUNG}}">
  ...
  <ul class="key-points">
    <li><strong>KI‑Reifegrad (0–100):</strong> Gesamt {{score_gesamt}} · Governance {{score_governance}} · Sicherheit {{score_security}} · Wertschöpfung {{score_wertschoepfung}} · Befähigung {{score_befaehigung}}</li>
  ...
  <aside class="transparency-box">
    <h4>Transparenz</h4>
    <ul>
      <li>Genutzte Dienste/Modelle: OpenAI API · Tavily · Perplexity</li>
