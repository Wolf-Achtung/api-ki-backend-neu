...
Du generierst Simulationsannahmen für eine Monte-Carlo-Analyse des Business Case.
...
**AI Act Konformität:**
- Konformitäts-Score: {{AI_ACT_CONFORMITY}}%
...
Erstelle realistische Verteilungsannahmen für die Monte-Carlo-Simulation.
Berücksichtige dabei:

1. **Unternehmensgröße ({{SIZE_LABEL}})**:
   - **Solo/Freelancer**: Höhere Varianz bei Umsetzungsgeschwindigkeit, kleinere Bandbreiten bei Kosten
...
4. **Fördererfolgswahrscheinlichkeit**:
   - Basierend auf Match-Scores und Programmverfügbarkeit
   - Solo: 30-50%
   - Team: 40-60%
   - KMU: 50-70%
...
**Orientierung an G30:**
- `min`: Optimistisches Szenario Investment (günstigster Fall)
...
**Bedeutung:**
- `< 1.0`: Risiken reduzieren erwartete Erträge
- `= 1.0`: Neutrale Risikoposition
- `> 1.0`: Günstige Risikosituation
...
Wahrscheinlichkeit, dass Förderung erfolgreich beantragt wird (0.0-1.0).

**Orientierung:**
- Keine Förderoptionen: 0.0
...
### Verteilungslogik
1. Für alle Parameter: min ≤ mode ≤ max
...
### Risikoanpassung
1. Höherer Risiko-Grade → breitere Verteilungen (höhere Varianz)
2. Höherer Risiko-Grade → niedrigere risk_factor Werte
3. Niedrigerer AI Act Conformity Score → niedrigere speed_factor

### Größenkonsistenz
1. Solo: Kleinere absolute Werte, höhere relative Varianz
2. Team: Mittlere Werte, moderate Varianz
3. KMU: Größere absolute Werte, niedrigere relative Varianz
...
- Werte müssen realistisch und konsistent mit G30/G33 sein
- Verteilungen müssen min ≤ mode ≤ max erfüllen
