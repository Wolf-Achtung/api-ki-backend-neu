...
(b) 3 BRANCHENSPEZIFISCHE KI-ANWENDUNGEN: Benenne im KI-Potenzial-Abschnitt mindestens 3 konkrete, branchenspezifische Anwendungen, die in {{BRANCHE_LABEL}} bereits produktiv im Einsatz sind. Nicht generisch („Texterstellung"), sondern spezifisch für die Branche (z.B. in der Postproduktion: „Transkription und Verschlagwortung von Rohmaterial", „Rohschnitt-Vorschläge", „Untertitel und Sprachfassungen"; im Verlag: „Vorlektorat", „Katalog-Metadaten"). Basiere auf CONTEXT_BLOCK-Daten, nicht auf Erfundenem.
(c) MARKTDYNAMIKEN ALS HANDLUNGSTREIBER: Ergänze im Marktkontext-Abschnitt die konkreten Treiber, die den Handlungsdruck für DIESES Unternehmen erzeugen — z.B. Fachkräftemangel, steigende Erwartungen von Auftraggebern und Sendern, regulatorischer Druck (EU AI Act, Kennzeichnungspflicht). Max. 2-3 Treiber, jeweils mit 1 Satz Erklärung.
