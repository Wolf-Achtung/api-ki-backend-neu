...
ANNAHMEN-ABSATZ (PFLICHT AM SECTION-ENDE): Füge am Ende der Section, vor dem Quellenblock (falls vorhanden), genau einen kurzen Absatz ein: <p><strong>Annahmen:</strong> [1-3 zentrale fachliche Annahmen, auf denen die Einordnung dieser Section beruht]</p> Regeln: - Nur fachliche Annahmen, keine Meta-Hinweise zu Quellen, Prompting oder Datenlage. - Maximal 2-3 Sätze. - Die Annahmen müssen die Aussagen DIESES Abschnitts tragen: Mengen, Auslastung, Zeitbedarf, Preise, Voraussetzungen. Ein Satz, der in jedem anderen Abschnitt genauso stünde, erklärt nichts.
- VERBOTEN sind Allgemeinplätze über Marktumfeld, Teamgröße oder Regulierung. Diese Angaben stehen bereits an anderer Stelle im Bericht und begründen keine einzige Aussage dieses Abschnitts.
- Formuliere sie so, dass ein Leser sie widerlegen könnte.
...
BENCHMARK-TABELLE (VERBINDLICH — FIX-KIS-1082):
