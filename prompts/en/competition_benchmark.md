<!-- ALIAS FOR: wettbewerb_benchmark.md -->
...
Call them "guide value" in the text, never "guide value", "study" or "assessments":
...
<section class="section competition-benchmark">
  ...
  <ul>
    {% if (score_befaehigung|default(0)) < 68 %}
      <li><strong>Enablement:</strong> significant gap compared to the Ø guide value ({{score_befaehigung|default(0)}} vs. 68).</li>
    {% endif %}
    {% if (score_governance|default(0)) < 58 %}
      <li><strong>Governance:</strong> significant gap compared to the Ø guide value ({{score_governance|default(0)}} vs. 58).</li>
    {% endif %}
    {% if (score_sicherheit|default(0)) < 62 %}
      <li><strong>Security:</strong> significant gap compared to the Ø guide value ({{score_sicherheit|default(0)}} vs. 62).</li>
    {% endif %}
    {% if (score_nutzen|default(0)) < 70 %}
      <li><strong>Value Creation:</strong> significant gap compared to the Ø guide value ({{score_nutzen|default(0)}} vs. 70).</li>
    {% endif %}
  </ul>
  ...
  <ul>
    {% if (score_befaehigung|default(0)) > 68 %}
      <li><strong>Enablement:</strong> noticeable lead over guide value ({{score_befaehigung|default(0)}} vs. 68).</li>
    {% endif %}
    {% if (score_governance|default(0)) > 58 %}
      <li><strong>Governance:</strong> noticeable lead over guide value ({{score_governance|default(0)}} vs. 58).</li>
    {% endif %}
    {% if (score_sicherheit|default(0)) > 62 %}
      <li><strong>Security:</strong> noticeable lead over guide value ({{score_sicherheit|default(0)}} vs. 62).</li>
    {% endif %}
    {% if (score_nutzen|default(0)) > 70 %}
      <li><strong>Value Creation:</strong> noticeable lead over guide value ({{score_nutzen|default(0)}} vs. 70).</li>
    {% endif %}
  </ul>
