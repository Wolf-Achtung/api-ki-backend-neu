...
<!-- ai_act_summary.md – v4.0 GOLD STANDARD+ (EU AI Act – branch- & size-aware, context-integrated)
     ...
     SIZE-AWARE:
       SOLO:
         - Focus on few deployment points, simple labeling, low complexity.
         - Minimal documentation, clear, pragmatic rules.
       TEAM (2-10):
         - Clearly name responsibilities, define simple processes.
         - Ensure consistent labeling across multiple people.
       SME (11-100):
     ...
     BRANCH-AWARE:
       ...
       - Marketing, Creative Industries:
           → Focus on clear labeling & fairness, avoiding misleading content.
...
<section class="section ai-act">
  ...
  <ul>
    ...
    <li>
      ...
      Focus on clear labeling, avoiding misleading content, asset review,
      brand-compliant use of generative AI.
    </li>
    <li>
      <strong>Manufacturing &amp; Production:</strong>
      AI-powered process optimization requires documented use and clear
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Clear labeling of AI-generated content becomes mandatory.</td>
      </tr>
    </tbody>
  </table>
  ...
  <ul>
    <li>
      <strong>Solo:</strong>
      Clearly identify few deployment points, formulate simple standard notices,
      briefly review results, no complex processes needed.
    </li>
    <li>
      <strong>Team (2-10):</strong>
      Clarify responsibilities (Who reviews? Who labels?),
      define uniform internal rules, keep coordination brief.
    </li>
    <li>
      <strong>SME (11-100):</strong>
      Written guidelines for AI use, fixed approval processes, documented
      roles and internal training; anchor governance elements early.
    </li>
  </ul>
  ...
  <ol>
    ...
    <li>Formulate internal mini-guideline: data, review, approvals, usage limits.</li>
  ...
  <ul>
    ...
    <li>Reputation risks with unclear or missing labeling of AI use.</li>
    <li>Loss of trust with customers, partners, and employees.</li>
    <li>Risks in audits or in regulated industries.</li>
  </ul>
