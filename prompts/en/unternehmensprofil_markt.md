...
<!-- unternehmensprofil_markt.md – v5.0 GOLD STANDARD+ (branch-aware, size-aware, context-integrated)
     ...
     PURPOSE:
       ...
       - Industry-related AI potential (2-4 typical use cases).
     ...
     IF A VARIABLE IS EMPTY OR FAULTY:
       ...
       - Ensure the section still makes sense and is complete.
     ...
     RESEARCH-CONTEXT (CONTEXT_BLOCK):
       - GENERIC INFORMATION ALLOWED:
         ...
         - Typical tools
       - NOT ALLOWED:
         - Specific market shares, revenues, competitor names
     ...
     SIZE-AWARE LOGIC (COMPANY_SIZE ∈ {"solo","team","kmu"}):
       SOLO:
         ...
         - Challenges: Capacity, prioritization, dependency on one person.
       ...
       TEAM (2-10):
         ...
         - AI leverage: Knowledge management, templates, unified workflows, shared standards.
     ...
     OUTPUT RULES:
       ...
       - Tone: Sober, factual, strategic, readable for management.
...
<section class="section unternehmensprofil-markt">
  ...
  <div class="markt-context">
    ...
    <p>
      ...
      recurring developments that also influence AI deployment in
      <strong>{{HAUPTLEISTUNG}}</strong>. These include, depending on information availability,
      increased digitalization, rising expectations for quality and speed, and
      growing pressure to make processes more efficient and data-driven.
      Where no reliable data is available, trends are marked as <em>not specified</em>.
    </p>

    <ul>
      <li><strong>Market dynamics:</strong> If industry data is available in context, briefly describe whether the market is stable, growing, or in transition; otherwise: <em>Not specified</em>.</li>
      ...
      <li><strong>Key drivers:</strong> Industry-typical drivers include e.g., cost pressure, skills shortage, rising quality requirements, or regulatory requirements; if no information in context: <em>Not specified</em>.</li>
      <li><strong>Challenges:</strong> Common challenges include data quality, interfaces between systems, limited internal resources, or regulatory uncertainty; if not substantiated: <em>Not specified</em>.</li>
    </ul>
  </div>
  ...
  <div class="ki-potenzial">
    ...
    <p>
      From the typical workflows and pain points of the <strong>{{BRANCHE_LABEL}}</strong> industry,
      several generic AI application areas emerge for the
      <strong>{{HAUPTLEISTUNG}}</strong> process. These can be derived without detailed specialized knowledge
      and serve as orientation for further development.
    </p>
    <ul>
      <li>Support for recurring tasks such as drafts, summaries, or standard analyses to save time and stabilize quality.</li>
      <li>Structuring and condensing existing information, e.g., from emails, documents, minutes, or specialized systems, to better prepare decisions.</li>
      <li>Quality and consistency checks of texts, data, or reports, oriented to industry-typical requirements and internal standards.</li>
    </ul>
  </div>
  ...
  <div class="wettbewerb">
    ...
    <p>
      ...
      <strong>{{BRANCHE_LABEL}}</strong> industry typically operate between specialized
      niche providers and larger market players. The role of AI depends heavily
    ...
    <ul>
      <li>
        ...
        {% if COMPANY_SIZE == "solo" %}
          High flexibility and quick decisions; adjustments in AI deployment can be implemented directly without lengthy coordination.
        {% elif COMPANY_SIZE == "team" %}
          Short paths and shared responsibility; new AI workflows can be tested in the team and refined step by step.
        {% else %}
      ...
      <li>
        ...
        {% if COMPANY_SIZE == "solo" %}
          Limited time and capacity; without clear prioritization, AI potential often remains unused.
        {% elif COMPANY_SIZE == "team" %}
          Coordination effort and resource scarcity; without clear roles, AI can get lost in daily business.
        {% else %}
          Coordination effort between teams and data silos; without governance, inconsistent solutions and duplicate structures threaten.
        {% endif %}
      </li>
      <li>
        <strong>AI Leverage:</strong>
        {% if COMPANY_SIZE == "solo" %}
          Focused automation of recurring tasks and building personal, AI-powered routines that deliver quick tangible relief.
        {% elif COMPANY_SIZE == "team" %}
